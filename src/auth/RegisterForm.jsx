...
const RegisterForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await apiData.post("/register", data);
            ...
            <div className="bg-white flex rounded-2xl shadow-lg w-[900px] overflow-hidden">
                <div className="w-1/2 bg-cover bg-opacity-40 bg-center hidden md:block" style={{ backgroundImage: "url('/img/plane.jpg')" }}>
                    <div className=" bg-opacity-40 h-full text-white flex flex-col justify-center items-center p-10">
                        ...
                        <Link to="/login/page"><span className="underline text-black hover:text-gray-800 font-semibold">Already Account?</span></Link>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <input
                            ...
                            className="w-full border border-gray-300 px-3 py-2 rounded-md"
                        />
                        {errors.password_confirmation && <p className="text-red-500 text-xs">{errors.password_confirmation[0]}</p>}
                        ...
                        <label className="flex items-center text-sm">
                            ...
                            <div className="flex gap-7">
                                ...
                                <Link to="/login/page" className="underline text-gray-400 font-semibold hover:text-gray-600">Login Page
                                </Link>
                            </div>
                        </label>
                        <div>
                        ...
                        <Link to="/forgot/password">
                            <div className="underline text-gray-400 mb-3  text-sm hover:text-gray-600">Forgot password?</div>
                        </Link>
